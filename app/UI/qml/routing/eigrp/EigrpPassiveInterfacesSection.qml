...
Rectangle {
    ...
    ColumnLayout {
        ...
        SectionTitle { text: qsTr("EIGRP PASSIVE INTERFACES") }
        ...
        GridLayout {
            ...
            StandardComboBox { id: modeCombo; Layout.fillWidth: true; labelText: qsTr("Mode"); model: [qsTr("Passive"), qsTr("No passive")]; valueModel: ["passive", "no-passive"] }
            StandardButton { text: qsTr("+ Add"); type: "Primary"; Layout.alignment: Qt.AlignBottom; onClicked: if (root.form.addPassiveInterfaceToSelectedProcess(ifaceField.text, modeCombo.currentValue)) ifaceField.clear() }
        }
