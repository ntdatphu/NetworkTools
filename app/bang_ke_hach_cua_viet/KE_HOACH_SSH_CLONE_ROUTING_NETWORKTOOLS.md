...
NetworkTools sẽ có một chính sách SSH thống nhất cho toàn ứng dụng, hỗ trợ Cisco IOS cũ mà không hạ mức bảo mật cho mọi thiết bị. Clone OSPF/EIGRP sẽ có validation rõ ràng, không sao chép Router ID nguy hiểm và không tác động ngoài phạm vi. Chức năng Sys sync sẽ thu thập được Static Route/Default Route, đồng thời bảo vệ các thay đổi local chưa push.
