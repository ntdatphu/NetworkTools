...
- Chưa có pull/sync running-config từ thiết bị về SQLite.
...
- VTP password trong schema được yêu cầu mã hoá; app chưa có decryptor nối với
  worker nên cấu hình VTP có authentication bị chặn và bí mật không bị ghi log.
