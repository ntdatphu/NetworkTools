...
- Full suite đạt 118/118 ngày 2026-07-17, gồm `UI/Main`, routing canonical, Switching/table family, bảng DHCP/NAT và routing networks, SFTP, Device Logs, Tool Catalog, loader lifecycle và Feature Bar CLI.
...
- [x] QML `UI/Main` smoke tải thành công trong fixture offscreen; full suite đạt 118/118 ngày 2026-07-17.
