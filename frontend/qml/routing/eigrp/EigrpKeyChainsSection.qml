    ...
    ColumnLayout {
        ...
        Repeater {
            ...
            delegate: RowLayout {
                ...
                StandardButton { Layout.preferredWidth: 34; type: "Icon"; icon.source: "qrc:/qt/qml/NetworkTools/resources/devicetabs/close.svg"; tooltip: "Remove key chain"; onClicked: root.form.removeKeyChainFromSelectedProcess(index) }
            }
        }
    }
}
