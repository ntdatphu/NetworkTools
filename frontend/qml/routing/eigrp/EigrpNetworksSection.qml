                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        RowLayout {
                            ...
                            StandardButton { Layout.preferredWidth: 34; type: "Icon"; icon.source: "qrc:/qt/qml/NetworkTools/resources/devicetabs/close.svg"; tooltip: "Remove network"; onClicked: root.form.removeNetworkFromSelectedProcess(index) }
                        }
                    }
                }
            }
