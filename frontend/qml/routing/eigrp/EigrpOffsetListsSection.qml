    ...
    ColumnLayout {
        ...
        Repeater {
            ...
            delegate: RowLayout {
                ...
                StandardButton { Layout.preferredWidth: 34; type: "Icon"; icon.source: "qrc:/qt/qml/NetworkTools/resources/devicetabs/close.svg"; tooltip: "Remove offset list"; onClicked: root.form.removeOffsetListFromSelectedProcess(index) }
            }
        }
    }
}
